...
import { ClinicStateArea } from '@/types/clinic';
...
interface ClinicReviewFormProps {
  ...
  states: ClinicStateArea[];
  areas: ClinicStateArea[];
  hours: ClinicHours[];
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="1.3415199" {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="103.6882118" {...field} />
                      </FormControl>
                      <div className="mt-2 text-sm text-gray-500">
                        Click{' '}
                        <Link

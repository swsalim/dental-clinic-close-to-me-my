...
export default function FormEditArea({ area }: EditAreaFormProps) {
  ...
  const [currentBannerImage, setCurrentBannerImage] = useState<string>(area.banner_image || '');
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (updatedArea) {
        ...
        setCurrentThumbnailImage(updatedArea.thumbnail_image || '');
        setCurrentBannerImage(updatedArea.banner_image || '');
      }
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Upload banner image for the area</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />

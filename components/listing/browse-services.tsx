          ...
          <div className="grid w-full grid-cols-1 gap-6 px-4 sm:grid-cols-2 md:w-7/12 lg:grid-cols-3">
            ...
            {services.map((service) => (
              <div
                ...
                className="dark:bg-gray-950/45609498f0aa flex cursor-pointer flex-col items-center justify-center rounded-xl bg-white p-8 text-gray-900 shadow-md outline-none transition hover:shadow-lg focus:ring-2 focus:ring-red-400 dark:text-gray-50"
                role="button">

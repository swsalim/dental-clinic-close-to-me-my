  ...
  const onSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      if (formData.price === 'instant') {
        ...
        // For free listings:
        // 1. Create a new FormData object to handle both text fields and file uploads
        // 2. Append all non-image form fields to FormData
        // 3. Append image files separately since they need special handling
        // 4. Submit to /api/clinics endpoint which will:

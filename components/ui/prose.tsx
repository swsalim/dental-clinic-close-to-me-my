  ...
  return (
    <Component
      className={cn(
        ...
        // links
        'prose-a:text-brand hover:prose-a:border-brand/80 prose-a:border-b-2 prose-a:border-transparent prose-a:font-normal prose-a:no-underline prose-a:duration-200',
        // pre
